...
module Taxes
  class AutoGenerateService < BaseService
    ...
    def create_country_tax(country_code)
      ...
      tax_name = "Frevois EU #{country_code.upcase} Standard"
      ...
      country_exceptions.each do |exception|
        ...
        tax_name = "Frevois EU #{country_code.upcase} #{exception["name"]} Standard"
        create_tax(tax_code, tax_name, exception['standard'])
      end
    end

    def create_generic_taxes
      create_tax('lago_eu_reverse_charge', 'Frevois EU Reverse Charge', 0.0)
      create_tax('lago_eu_tax_exempt', 'Frevois EU Tax Exempt', 0.0)
    end
    ...
    def create_tax(tax_code, tax_name, rate)
      ...
      tax.name = tax_name
      tax.rate = rate
      tax.description = 'Generated By Frevois EU VAT management'
