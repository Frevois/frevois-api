...
class ActiveRecord::Base
  ...
  # source://ransack/4.2.1/lib/ransack/adapters/active_record/base.rb#9
  ...
  # source://ransack/4.2.1/lib/ransack/adapters/active_record/base.rb#8
  def _ransackers; end
  ...
  # source://activestorage/8.0.1/lib/active_storage/reflection.rb#53
...
class ActiveRecord::ConnectionAdapters::Clickhouse::OID::Uuid < ::ActiveModel::Type::Value
  ...
  # source://activemodel/8.0.1/lib/active_model/type/value.rb#43
  def serialize(value); end
...
module ActiveRecord::ConnectionAdapters::Clickhouse::SchemaStatements
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#136
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#132
  def migration_context; end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#128
  ...
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#241
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#189
  def apply_format(sql, format); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#226
  def create_table_definition(table_name, **options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#264
  def extract_default_function(default); end

  # Extracts the value from a PostgreSQL column default definition.
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#254
  def extract_value_from_default(default_expression, default_type); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#272
  def format_body_response(body, format); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#285
  def format_from_json_compact(body); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#289
  def format_from_json_compact_each_row_with_names_and_types(body); end

  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#268
  def has_default_function?(default); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#217
  def log_with_debug(sql, name = T.unsafe(nil)); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#230
  def new_column_from_field(table_name, field, _definitions); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#306
  def parse_json_payload(payload); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#193
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse/schema_statements.rb#222
...
class ActiveRecord::ConnectionAdapters::ClickhouseAdapter < ::ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#408
  def add_column(table_name, column_name, type, **options); end

  # Adds index description to tables metadata
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#439
  def add_index(table_name, expression, **options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#500
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#518
  def build_insert_sql(insert); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#422
  def change_column(table_name, column_name, type, **options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#433
  def change_column_default(table_name, column_name, default); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#427
  ...
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#461
  def clear_index(table_name, name, if_exists: T.unsafe(nil), partition: T.unsafe(nil)); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#470
  def cluster; end
  ...
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#311
  def create_database(name); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#359
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#332
  def create_table(table_name, request_settings: T.unsafe(nil), **options, &block); end

  # @yield [td]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#319
  def create_view(table_name, request_settings: T.unsafe(nil), **options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#478
  def database; end

  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#494
  def database_engine_atomic?; end

  # Drops a ClickHouse database.
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#365
  def drop_database(name); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#398
  def drop_function(name, options = T.unsafe(nil)); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#373
  def drop_functions; end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#383
  ...
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#451
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#416
  ...
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#445
  def remove_index(table_name, name); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#379
  def rename_table(table_name, new_name); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#474
  def replica; end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#490
  ...
  # @return [String]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#305
  def show_create_table(table, single_line: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#510
  def supports_insert_on_duplicate_skip?; end

  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#514
  ...
  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#482
  def use_default_replicated_merge_tree_params?; end

  # @return [Boolean]
  #
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#486
  def use_replica?; end
  ...
  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#529
  def change_column_for_alter(table_name, column_name, type, **options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#525
  def last_inserted_id(result); end

  private

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#554
  def apply_replica(table, options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#565
  def configure_replica(table, options); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#537
  def connect; end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#550
  def reconnect; end
...
module ActiveRecord::ModelSchema
  ...
  class << self
    # source://activerecord/8.0.1/lib/active_record/model_schema.rb#196
...
module ActiveRecord::ModelSchema::ClassMethods
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#436
  def _returning_columns_for_insert(connection); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#420
  def attributes_builder; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#472
  def column_defaults; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#463
  def column_for_attribute(name); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#478
  def column_names; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#432
  def columns; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#427
  def columns_hash; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#489
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#302
  def full_table_name_prefix; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#306
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#331
  def ignored_columns; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#366
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#534
  def load_schema; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#411
  def next_sequence_value; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#405
  def prefetch_primary_key?; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#312
  def protected_environments; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#321
  def protected_environments=(environments); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#285
  def quoted_table_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#325
  def real_inheritance_column=(value); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#523
  def reset_column_information; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#379
  def reset_sequence_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#290
  def reset_table_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#371
  def sequence_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#398
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#482
  def symbol_column_to_string(name_symbol); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#416
  def table_exists?; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#260
  def table_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#270
  ...
  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#446
  def yaml_encoder; end

  protected

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#549
  def initialize_load_schema_monitor; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#553
  def reload_schema_from_cache(recursive = T.unsafe(nil)); end

  private

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#606
  def compute_table_name; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#574
  def inherited(child_class); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#587
  def load_schema!; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#583
  def schema_loaded?; end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#622
  def type_for_column(connection, column); end

  # source://activerecord/8.0.1/lib/active_record/model_schema.rb#600
...
class ActiveRecord::TypeCaster::Map
  # source://activerecord/8.0.1/lib/active_record/type_caster/map.rb#6
  def initialize(klass); end

  # source://clickhouse-activerecord//lib/active_record/connection_adapters/clickhouse_adapter.rb#41
  def is_view; end

  # source://activerecord/8.0.1/lib/active_record/type_caster/map.rb#10
  def type_cast_for_database(attr_name, value); end

  # source://activerecord/8.0.1/lib/active_record/type_caster/map.rb#15
  def type_for_attribute(name); end

  private

  # source://activerecord/8.0.1/lib/active_record/type_caster/map.rb#20
  def klass; end
end
...
class Arel::Visitors::Clickhouse < ::Arel::Visitors::ToSql
  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#12
  ...
  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#114
  def sanitize_as_setting_name(value); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#106
  def sanitize_as_setting_value(value); end

  # https://clickhouse.com/docs/en/sql-reference/statements/delete
  # DELETE and UPDATE in ClickHouse working only without table name
  #
  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#23
  def visit_Arel_Attributes_Attribute(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#48
  def visit_Arel_Nodes_DeleteStatement(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#93
  def visit_Arel_Nodes_DoesNotMatch(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#53
  def visit_Arel_Nodes_Final(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#59
  ...
  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#98
  def visit_Arel_Nodes_Rows(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#31
  def visit_Arel_Nodes_SelectOptions(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#64
  def visit_Arel_Nodes_Settings(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#36
  def visit_Arel_Nodes_UpdateStatement(o, collector); end

  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#77
  ...
  #
  # source://clickhouse-activerecord//lib/arel/visitors/clickhouse.rb#123
