...
module Dry::Schema
  class << self
    # source://dry-schema/1.13.4/lib/dry/schema.rb#86
    def Form(**options, &block); end

    # source://dry-schema/1.13.4/lib/dry/schema.rb#106
    def JSON(**options, &block); end

    # source://dry-schema/1.13.4/lib/dry/schema.rb#86
    def Params(**options, &block); end

    # source://dry-schema/1.13.4/lib/dry/schema.rb#48
    def config; end

    # source://dry-schema/1.13.4/lib/dry/schema.rb#67
    def define(**options, &block); end

    # source://dry-schema/1.13.4/lib/dry/schema.rb#18
    def loader; end
  end
end
...
class Dry::Schema::Path
  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#57
  def initialize(keys); end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#88
  def &(other); end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#79
  def <=>(other); end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#69
  def each(&block); end
  ...
  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#74
  def include?(other); end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#16
  def keys; end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#95
  def last; end
  ...
  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#100
  def same_root?(other); end

  # source://dry-schema/1.13.4/lib/dry/schema/path.rb#62
  def to_h(value = T.unsafe(nil)); end

  class << self
    # source://dry-schema/1.13.4/lib/dry/schema/path.rb#43
    def [](spec); end

    # source://dry-schema/1.13.4/lib/dry/schema/path.rb#27
    def call(spec); end

    # source://dry-schema/1.13.4/lib/dry/schema/path.rb#50
...
module Dry::Validation
  ...
  class << self
    ...
    def Contract(options = T.unsafe(nil), &block); end
...
class Dry::Validation::Contract
  ...
  # @return [String]
  #
  # source://dry-validation//lib/dry/validation/contract.rb#117
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://dry-validation//lib/dry/validation/contract.rb#124
  ...
  # @return [Proc, #to_proc]
  #
  # source://dry-validation//lib/dry/validation/contract.rb#152
  ...
  #
  # source://dry-validation//lib/dry/validation/contract.rb#161
  def messages; end
end
...
class Dry::Validation::Result
  ...
  # @api private
  #
  # source://dry-validation//lib/dry/validation/result.rb#211
  def deconstruct; end
  ...
  # @api private
  #
  # source://dry-validation//lib/dry/validation/result.rb#204
  ...
  # @api private
  #
  # source://dry-validation//lib/dry/validation/result.rb#219
  def initialize_errors(options = T.unsafe(nil)); end

  # @api private
  #
  # source://dry-validation//lib/dry/validation/result.rb#224
...
class Dry::Validation::Values
  ...
  # @api private
  #
  # source://dry-validation//lib/dry/validation/values.rb#94
  def method_missing(meth, *args, **_arg2, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-validation//lib/dry/validation/values.rb#87
  def respond_to_missing?(meth, include_private = T.unsafe(nil)); end
end
