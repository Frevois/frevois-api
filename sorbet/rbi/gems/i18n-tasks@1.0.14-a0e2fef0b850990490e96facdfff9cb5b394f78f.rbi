...
class I18n::Tasks::Scanners::PrismScanner < ::I18n::Tasks::Scanners::FileScanner
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanner.rb#42
  def process_prism_parse_result(path, parsed, comments = T.unsafe(nil)); end

  # Extract all occurrences of translate calls from the file at the given path.
  #
  # @return [Array<[key, Results::KeyOccurrence]>] each occurrence found in the file
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanner.rb#25
  def scan_file(path); end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanner.rb#63
I18n::Tasks::Scanners::PrismScanner::PARSER = Prism

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanner.rb#65
I18n::Tasks::Scanners::PrismScanner::RAILS_VISITOR = I18n::Tasks::Scanners::PrismScanners::RailsVisitor

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanner.rb#64
I18n::Tasks::Scanners::PrismScanner::RUBY_VISITOR = I18n::Tasks::Scanners::PrismScanners::Visitor
...
# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#20
class I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [BaseNode] a new instance of BaseNode
  #
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#35
  def prepare; end

  # @return [Boolean]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#31
  def support_relative_keys?; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#21
I18n::Tasks::Scanners::PrismScanners::BaseNode::MAGIC_COMMENT_PREFIX = T.let(T.unsafe(nil), Regexp)

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#22
I18n::Tasks::Scanners::PrismScanners::BaseNode::MAGIC_COMMENT_SKIP_PRISM = T.let(T.unsafe(nil), String)

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#393
class I18n::Tasks::Scanners::PrismScanners::BeforeActionNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [BeforeActionNode] a new instance of BeforeActionNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#396
  def initialize(node:, only:, except:, name: T.unsafe(nil), translation_nodes: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#419
  def add_method(method); end

  # @return [Boolean]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#426
  def applies_to?(method_name); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#415
  def calls; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#407
  def inspect; end

  # Returns the value of attribute name.
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#394
  def name; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#438
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#411
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#521
class I18n::Tasks::Scanners::PrismScanners::CallNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [CallNode] a new instance of CallNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#522
  def initialize(node:, comment_translations:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#532
  def name; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#536
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#528
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#72
class I18n::Tasks::Scanners::PrismScanners::ClassNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [ClassNode] a new instance of ClassNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#75
  def initialize(node:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#86
  def add_child_node(child_node); end
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#126
  def class_type; end
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#94
  def path_name; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#102
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#122
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#144
class I18n::Tasks::Scanners::PrismScanners::ControllerNode < ::I18n::Tasks::Scanners::PrismScanners::ClassNode
  # @return [ControllerNode] a new instance of ControllerNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#145
  def initialize(node:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#150
  def add_child_node(child_node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#172
  def class_type; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#158
  def prepare; end

  # @return [Boolean]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#176
  def support_relative_keys?; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#181
class I18n::Tasks::Scanners::PrismScanners::DefNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [DefNode] a new instance of DefNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#184
  def initialize(node:, calls:, private_method:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#196
  def add_call_from(method_name); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#242
  def before_action_translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#192
  def inspect; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#206
  def name; end
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#182
  def private_method; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#214
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#223
  def translation_nodes_from_calls(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#210
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#451
class I18n::Tasks::Scanners::PrismScanners::HumanAttributeNameNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [HumanAttributeNameNode] a new instance of HumanAttributeNameNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#452
  def initialize(node:, model:, argument:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#475
  def key; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#463
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#459
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#482
class I18n::Tasks::Scanners::PrismScanners::ModelNameNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [ModelNameNode] a new instance of ModelNameNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#485
  def initialize(node:, model:, count: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#508
  def count_key; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#516
  def key; end

  # Returns the value of attribute model.
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#483
  def model; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#496
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#492
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#40
class I18n::Tasks::Scanners::PrismScanners::ModuleNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [ModuleNode] a new instance of ModuleNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#41
  def initialize(node:, child_nodes:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#47
  def inspect; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#55
  def name; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#59
  def path_name; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#63
  def translation_nodes(path: T.unsafe(nil), options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#51
  def type; end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#15
class I18n::Tasks::Scanners::PrismScanners::RailsVisitor < ::I18n::Tasks::Scanners::PrismScanners::Visitor
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#72
  def handle_before_action(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#118
  def handle_human_attribute_name(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#104
  def handle_human_call(node, comment_translations); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#57
  def handle_translation_call(node, comment_translations); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#34
  def visit_call_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/rails_visitor.rb#16
  def visit_class_node(node); end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#254
class I18n::Tasks::Scanners::PrismScanners::TranslationNode < ::I18n::Tasks::Scanners::PrismScanners::BaseNode
  # @return [TranslationNode] a new instance of TranslationNode
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#257
  def initialize(node:, key:, receiver:, options: T.unsafe(nil), comment_translations: T.unsafe(nil), path: T.unsafe(nil), context_options: T.unsafe(nil)); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#321
  def full_key(context_path:); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#277
  def inspect; end
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#301
  ...
  # @return [Boolean]
  #
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#297
  def relative_key?; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#293
  def type; end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#281
  def with_context(path: T.unsafe(nil), options: T.unsafe(nil)); end

  private

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#352
  def occurrence(file_path); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/nodes.rb#373
  ...
  def support_relative_keys?(context_path); end
end

# source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#13
class I18n::Tasks::Scanners::PrismScanners::Visitor < ::Prism::Visitor
  ...
  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#30
  def prepare_comments_by_line(comments); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#157
  def process_arguments(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#127
  def visit_arguments_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#134
  def visit_array_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#103
  def visit_assoc_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#87
  def visit_call_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#69
  def visit_class_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#123
  def visit_constant_read_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#119
  def visit_decimal_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#81
  def visit_def_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#115
  def visit_integer_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#138
  def visit_keyword_hash_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#62
  def visit_module_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#58
  def visit_program_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#54
  def visit_statements_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#111
  def visit_string_node(node); end

  # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#107
  def visit_symbol_node(node); end

  class << self
    # @return [Boolean]
    #
    # source://i18n-tasks//lib/i18n/tasks/scanners/prism_scanners/visitor.rb#22
...
class I18n::Tasks::Translators::OpenAiTranslator < ::I18n::Tasks::Translators::BaseTranslator
  ...
  #
  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#24
  def initialize(*_arg0); end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#48
  def no_results_error_message; end
  ...
  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#33
  def options_for_translate_values(from:, to:, **options); end

  private

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#58
  def api_key; end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#109
  def build_messages(values, from, to); end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#67
  def model; end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#71
  def system_prompt; end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#89
  def translate(values, from, to); end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#75
  def translate_values(list, from:, to:); end

  # source://i18n-tasks//lib/i18n/tasks/translators/openai_translator.rb#54
  def translator; end
end
