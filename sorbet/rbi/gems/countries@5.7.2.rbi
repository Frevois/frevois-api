...
class ISO3166::Country
  ...
  #
  # source://countries//lib/countries/country.rb#23
  def initialize(country_data); end

  # source://countries//lib/countries/country.rb#50
  def <=>(other); end

  # source://countries//lib/countries/country.rb#38
  def ==(other); end

  # source://countries//lib/countries/country.rb#12
  ...
  # source://countries//lib/countries/country.rb#18
  def bounds; end
  ...
  #
  # source://countries//lib/countries/country.rb#9
  def data; end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#42
  def eql?(other); end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#70
  ...
  # source://countries//lib/countries/country.rb#46
  def hash; end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#75
  def in_eea?; end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#65
  def in_g20?; end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#60
  def in_g7?; end
  ...
  #
  # source://countries//lib/countries/country.rb#90
  ...
  # source://countries//lib/countries/country.rb#94
  def to_s; end
  ...
  # @return [Boolean]
  #
  # source://countries//lib/countries/country.rb#28
  def valid?; end
  ...
  # source://countries//lib/countries/country.rb#214
  def reload; end
end
...
module ISO3166::CountrySubdivisionMethods
  ...
  # source://countries//lib/countries/country/country_subdivision_methods.rb#64
  def states; end
  ...
  # source://countries//lib/countries/country/country_subdivision_methods.rb#78
...
# source://countries//lib/countries/structure.rb#60
...
class ISO3166::Data
  ...
  class << self
    ...
    # source://countries//lib/countries/data.rb#54
    def codes; end

    # source://countries//lib/countries/data.rb#70
    def datafile_path(file_array); end

    # source://countries//lib/countries/data.rb#65
    ...
    # source://countries//lib/countries/data.rb#59
    ...
    # @return [Boolean]
    #
    # source://countries//lib/countries/data.rb#125
    def cache_flush_required?; end

    # source://countries//lib/countries/data.rb#116
    ...
    #
    # source://countries//lib/countries/data.rb#121
    def internal_codes; end

    # source://countries//lib/countries/data.rb#139
    def load_alpha2_translation_for_locale(alpha2, locale, locale_names); end

    # source://countries//lib/countries/data.rb#159
    def load_cache(file_array); end

    # source://countries//lib/countries/data.rb#76
    def load_data!; end

    # @return [Boolean]
    #
    # source://countries//lib/countries/data.rb#112
    def load_required?; end

    # source://countries//lib/countries/data.rb#129
    def load_translations(locale); end

    # source://countries//lib/countries/data.rb#171
    def subdivision_file_path(alpha2); end

    # source://countries//lib/countries/data.rb#87
    def sync_translations!; end

    # source://countries//lib/countries/data.rb#99
    ...
    # source://countries//lib/countries/data.rb#145
    def unload_translations(locale); end

    # @return [Boolean]
    #
    # source://countries//lib/countries/data.rb#107
    def use_mutex?; end
  end
end
