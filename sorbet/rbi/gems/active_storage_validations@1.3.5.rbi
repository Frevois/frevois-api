...
class ActiveStorageValidations::Analyzer::ImageAnalyzer < ::ActiveStorageValidations::Analyzer
  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer.rb#15
  def metadata; end

  private

  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer.rb#27
  ...
  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer.rb#52
  def image_from_tempfile_path(tempfile, file_representation); end

  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer.rb#65
  def read_image; end

  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer.rb#73
...
class ActiveStorageValidations::Analyzer::ImageAnalyzer::ImageMagick < ::ActiveStorageValidations::Analyzer::ImageAnalyzer
  ...
  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer/image_magick.rb#36
  def image_from_path(path); end

  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer/image_magick.rb#11
  def read_image; end

  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer/image_magick.rb#42
  def rotated_image?(image); end
end
...
class ActiveStorageValidations::Analyzer::ImageAnalyzer::Vips < ::ActiveStorageValidations::Analyzer::ImageAnalyzer
  ...
  # source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer/vips.rb#35
  def image_from_path(path); end
...
# source://active_storage_validations//lib/active_storage_validations/analyzer/image_analyzer/vips.rb#50
...
class ActiveStorageValidations::AspectRatioValidator < ::ActiveModel::EachValidator
  ...
  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#36
  ...
  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#102
  ...
  def image_metadata_missing?(record, attribute, attachable, flat_options, metadata); end

  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#44
  ...
  def validate_landscape_aspect_ratio(record, attribute, attachable, flat_options, metadata); end

  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#74
  def validate_portrait_aspect_ratio(record, attribute, attachable, flat_options, metadata); end

  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#90
  def validate_regex_aspect_ratio(record, attribute, attachable, flat_options, metadata); end

  # source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#66
  def validate_square_aspect_ratio(record, attribute, attachable, flat_options, metadata); end
end
...
# source://active_storage_validations//lib/active_storage_validations/aspect_ratio_validator.rb#29
...
class ActiveStorageValidations::ContentTypeValidator < ::ActiveModel::EachValidator
  ...
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#45
  ...
  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#119
  ...
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#146
  ...
  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#183
  def invalid_content_type?(content_type); end

  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#160
  def invalid_content_type_option_message(content_type); end

  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#187
  ...
  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#63
  def is_valid?(record, attribute, attachable); end

  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#115
  def marcel_attachable_content_type(attachable); end

  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/content_type_validator.rb#103
