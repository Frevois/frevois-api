...
class ActiveJob::Base
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#48
  def lock_options; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#48
  def lock_options?; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#47
...
module ActiveJob::Uniqueness::ActiveJobPatch
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#67
  def lock_key(*_arg0, **_arg1, &_arg2); end

  # Override in your job class if you want to customize arguments set for a digest.
  #
  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#62
  def lock_key_arguments; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#69
  def lock_key_generator; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#57
...
module ActiveJob::Uniqueness::ActiveJobPatch::ClassMethods
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#37
  def unlock!(*arguments); end

  # source://activejob-uniqueness//lib/active_job/uniqueness/active_job_patch.rb#43
...
class ActiveJob::Uniqueness::Configuration
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/configuration.rb#26
  ...
  #
  # source://activejob-uniqueness//lib/active_job/uniqueness/configuration.rb#32
...
class ActiveJob::Uniqueness::LockManager < ::Redlock::Client
  ...
  #
  # source://activejob-uniqueness//lib/active_job/uniqueness/lock_manager.rb#21
  def delete_locks(wildcard); end

  private

  # source://activejob-uniqueness//lib/active_job/uniqueness/lock_manager.rb#33
...
class ActiveJob::Uniqueness::Strategies::Base
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#53
  def after_perform; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#43
  def around_enqueue(block); end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#48
  def around_perform(block); end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#35
  def before_enqueue; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#39
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#23
  ...
  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#29
  def unlock(resource:, event: T.unsafe(nil)); end

  private

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#89
  def abort_job; end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#80
  def handle_conflict(on_conflict:, resource:, event: T.unsafe(nil)); end

  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#95
  def instrument(action, payload = T.unsafe(nil)); end

  # @raise [JobNotUnique]
  #
  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#99
...
# source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#57
module ActiveJob::Uniqueness::Strategies::Base::LockingOnEnqueue
  # source://activejob-uniqueness//lib/active_job/uniqueness/strategies/base.rb#65
  def around_enqueue(block); end
