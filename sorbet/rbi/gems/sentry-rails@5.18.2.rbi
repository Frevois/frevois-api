...
module Sentry
  class << self
    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#304
    def add_breadcrumb(breadcrumb, **options); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#523
    def add_global_event_processor(&block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#104
    def apply_patches(config); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#72
    def background_worker; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#72
    def background_worker=(_arg0); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#80
    def backpressure_monitor; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#463
    def capture_check_in(slug, status, **options); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#447
    def capture_event(event); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#411
    def capture_exception(exception, **options, &block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#439
    def capture_message(message, **options, &block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#341
    def clone_hub_to_current_thread; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#242
    def close; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#156
    def configuration; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#357
    def configure_scope(&block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#567
    def continue_trace(env, **options); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#289
    def csp_report_uri; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#505
    def exception_captured?(exc); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#54
    def exception_locals_tp; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#540
    def get_baggage; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#325
    def get_current_client; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#314
    def get_current_hub; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#333
    def get_current_scope; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#297
    def get_main_hub; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#549
    def get_trace_propagation_headers; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#558
    def get_trace_propagation_meta; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#531
    def get_traceparent; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#220
    def init(&block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#277
    def initialized?; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#120
    def integrations; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#497
    def last_event_id; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#583
    def logger; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#84
    ...
    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#128
    def register_integration(name, version); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#89
    def register_patch(key, patch = T.unsafe(nil), target = T.unsafe(nil), &block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#111
    def registered_patches; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#588
    def sdk_meta; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#163
    def send_event(*args); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#76
    def session_flusher; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#209
    def set_context(*args); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#195
    def set_extras(*args); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#188
    def set_tags(*args); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#202
    def set_user(*args); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#471
    def start_transaction(**options); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#575
    ...
    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#593
    def utc_now; end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#489
    def with_child_span(**attributes, &block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#428
    def with_exception_captured(**options, &block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#382
    def with_scope(&block); end

    # source://sentry-ruby/5.18.2/lib/sentry-ruby.rb#402
...
class Sentry::Configuration
  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#351
  def initialize; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#26
  def app_dirs_pattern; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#26
  def app_dirs_pattern=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#33
  def async; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#412
  def async=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#269
  def auto_session_tracking; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#269
  def auto_session_tracking=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#50
  def background_worker_max_queue; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#50
  def background_worker_max_queue=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#43
  def background_worker_threads; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#43
  def background_worker_threads=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#61
  def backtrace_cleanup_callback; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#61
  def backtrace_cleanup_callback=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#70
  def before_breadcrumb; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#453
  def before_breadcrumb=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#84
  def before_send; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#441
  def before_send=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#97
  def before_send_transaction; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#447
  def before_send_transaction=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#109
  def breadcrumbs_logger; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#428
  def breadcrumbs_logger=(logger); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#152
  def capture_exception_frame_locals; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#166
  def capture_exception_frame_locals=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#117
  def context_lines; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#117
  def context_lines=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#237
  def cron; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#542
  def csp_report_uri; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#126
  def debug; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#126
  def debug=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#563
  def detect_release; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#130
  def dsn; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#400
  def dsn=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#275
  def enable_backpressure_handling; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#275
  def enable_backpressure_handling=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#260
  def enable_tracing; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#467
  def enable_tracing=(enable_tracing); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#134
  def enabled_environments; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#134
  def enabled_environments=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#520
  def enabled_in_current_env?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#295
  def enabled_patches; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#295
  def enabled_patches=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#121
  def environment; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#459
  def environment=(environment); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#576
  def error_messages; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#299
  def errors; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#507
  def exception_class_allowed?(exc); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#138
  def exclude_loggers; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#138
  def exclude_loggers=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#143
  ...
  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#147
  ...
  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#284
  def instrumenter; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#463
  def instrumenter=(instrumenter); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#472
  def is_numeric_or_nil?(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#178
  def linecache; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#178
  def linecache=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#183
  def logger; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#183
  def logger=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#113
  def max_breadcrumbs; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#113
  def max_breadcrumbs=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#241
  def metrics; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#290
  def profiles_sample_rate; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#481
  def profiles_sample_rate=(profiles_sample_rate); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#535
  def profiling_enabled?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#188
  def project_root; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#188
  def project_root=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#192
  def propagate_traces; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#192
  def propagate_traces=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#196
  ...
  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#201
  def release; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#406
  def release=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#497
  def sample_allowed?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#206
  def sample_rate; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#206
  def sample_rate=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#265
  def send_client_reports; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#265
  def send_client_reports=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#219
  def send_default_pii; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#219
  def send_default_pii=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#210
  def send_modules; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#210
  def send_modules=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#487
  def sending_allowed?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#491
  def sending_to_dsn_allowed?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#400
  def server=(value); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#229
  def server_name; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#229
  def server_name=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#503
  def session_tracking?; end

  # source://sentry-sidekiq/5.18.2/lib/sentry/sidekiq/configuration.rb#3
  def sidekiq; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#223
  def skip_rake_integration; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#223
  def skip_rake_integration=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#160
  def spotlight; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#160
  def spotlight=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#552
  def stacktrace_builder; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#280
  def trace_propagation_targets; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#280
  def trace_propagation_targets=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#245
  def traces_sample_rate; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#476
  def traces_sample_rate=(traces_sample_rate); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#255
  def traces_sampler; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#255
  def traces_sampler=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#529
  def tracing_enabled?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#233
  def transport; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#226
  def trusted_proxies; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#226
  def trusted_proxies=(_arg0); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#524
  def valid_sample_rate?(sample_rate); end

  private

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#618
  def capture_in_environment?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#634
  def environment_from_env; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#589
  def excluded_exception?(incoming_exception); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#595
  def excluded_exception_classes; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#599
  def get_exception_class(x); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#583
  def init_dsn(dsn_string); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#603
  def matches_exception?(excluded_exception_class, incoming_exception); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#658
  def processor_count; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#652
  def run_post_initialization_callbacks; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#648
  def running_on_heroku?; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#611
  def safe_const_get(x); end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#638
  def server_name_from_env; end

  # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#625
  def valid?; end

  class << self
    # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#346
    def add_post_initialization_callback(&block); end

    # source://sentry-ruby/5.18.2/lib/sentry/configuration.rb#341
