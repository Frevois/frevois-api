...
module ActiveModel::Validations
  ...
  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#330
  def errors; end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#402
  def invalid?(context = T.unsafe(nil)); end

  def read_attribute_for_validation(*_arg0); end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#363
  def valid?(context = T.unsafe(nil)); end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#363
  def validate(context = T.unsafe(nil)); end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#411
  def validate!(context = T.unsafe(nil)); end

  # source://activemodel/7.1.5.1/lib/active_model/validations/with.rb#144
  def validates_with(*args, &block); end

  private

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#434
  def init_internals; end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#312
  def initialize_dup(other); end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#445
  def raise_validation_error; end

  # source://activemodel/7.1.5.1/lib/active_model/validations.rb#440
...
class Valvat
  ...
  class << self
    # source://valvat//lib/valvat/options.rb#28
...
class Valvat::Configuration
  ...
  # source://valvat//lib/valvat/configuration.rb#52
  def [](key); end

  # source://valvat//lib/valvat/configuration.rb#56
  def configure(options); end
...
class Valvat::Lookup::Base
  ...
  # source://valvat//lib/valvat/lookup/base.rb#15
  def perform; end
  ...
  #
  # source://valvat//lib/valvat/lookup/base.rb#32
  def build_request(uri); end

  # @raise [NotImplementedError]
  #
  # source://valvat//lib/valvat/lookup/base.rb#28
  def endpoint_uri; end

  # source://valvat//lib/valvat/lookup/base.rb#40
  def fetch(uri, limit = T.unsafe(nil)); end

  # source://valvat//lib/valvat/lookup/base.rb#62
  def options_for(uri); end

  # @raise [NotImplementedError]
  #
  # source://valvat//lib/valvat/lookup/base.rb#36
  def parse(body); end

  # source://valvat//lib/valvat/lookup/base.rb#54
  def send_request(uri); end
end

# source://valvat//lib/valvat/lookup/hmrc.rb#10
class Valvat::Lookup::HMRC < ::Valvat::Lookup::Base
  # source://valvat//lib/valvat/lookup/hmrc.rb#17
  def perform; end

  private

  # source://valvat//lib/valvat/lookup/hmrc.rb#78
  def build_fault(raw); end

  # source://valvat//lib/valvat/lookup/hmrc.rb#31
  def build_request(uri); end
  ...
  #
  # source://valvat//lib/valvat/lookup/hmrc.rb#43
  def convert(raw); end

  # source://valvat//lib/valvat/lookup/hmrc.rb#25
  def endpoint_uri; end
  ...
  # }
  #
  # source://valvat//lib/valvat/lookup/hmrc.rb#66
  def format_address(address); end

  # source://valvat//lib/valvat/lookup/hmrc.rb#35
  def parse(body); end
end

# source://valvat//lib/valvat/lookup/hmrc.rb#11
Valvat::Lookup::HMRC::ENDPOINT_URL = T.let(T.unsafe(nil), String)

# source://valvat//lib/valvat/lookup/hmrc.rb#70
...
class Valvat::Options
  ...
  # source://valvat//lib/valvat/options.rb#23
  def [](key); end
end
