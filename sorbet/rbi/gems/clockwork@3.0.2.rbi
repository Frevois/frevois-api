...
module Clockwork::Methods
  ...
  # source://clockwork-test/0.5.1/lib/clockwork/test.rb#17
  def configure(&block); end

  # source://clockwork//lib/clockwork.rb#34
  def error_handler(&block); end

  # source://clockwork-test/0.5.1/lib/clockwork/test.rb#12
  def every(period, job, options = T.unsafe(nil), &block); end

  # source://clockwork-test/0.5.1/lib/clockwork/test.rb#22
  def handler(&block); end

  # source://clockwork-test/0.5.1/lib/clockwork/test.rb#27
  def on(event, options = T.unsafe(nil), &block); end
