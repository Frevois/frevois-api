...
# source://sidekiq//lib/sidekiq/fetch.rb#8
class Sidekiq::BasicFetch
  ...
  #
  # source://sidekiq//lib/sidekiq/fetch.rb#30
  def initialize(cap); end

  # source://sidekiq//lib/sidekiq/fetch.rb#51
  def bulk_requeue(inprogress); end

  # source://sidekiq-throttled/1.4.0/lib/sidekiq/throttled/patches/throttled_retriever.rb#10
  ...
  #
  # source://sidekiq-throttled/1.4.0/lib/sidekiq/throttled/patches/basic_fetch.rb#34
  def queues_cmd; end
end
...
#
# source://sidekiq//lib/sidekiq/fetch.rb#12
Sidekiq::BasicFetch::TIMEOUT = T.let(T.unsafe(nil), Integer)

# source://sidekiq//lib/sidekiq/fetch.rb#14
class Sidekiq::BasicFetch::UnitOfWork < ::Struct
  # source://sidekiq//lib/sidekiq/fetch.rb#15
  def acknowledge; end

  # Returns the value of attribute config
  #
  # @return [Object] the current value of config
  def config; end

  # Sets the attribute config
  #
  # @param value [Object] the value to set the attribute config to.
  ...
  # source://sidekiq//lib/sidekiq/fetch.rb#19
  def queue_name; end

  # source://sidekiq//lib/sidekiq/fetch.rb#23
  def requeue; end
...
# end
#
# source://sidekiq//lib/sidekiq/capsule.rb#20
class Sidekiq::Capsule
  ...
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#32
  ...
  # @yield [@client_chain]
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#80
  def client_middleware; end

  # Returns the value of attribute concurrency.
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#26
  def concurrency; end

  # Sets the attribute concurrency
  #
  # @param value the value to set the attribute concurrency to.
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#26
  ...
  # source://sidekiq//lib/sidekiq/capsule.rb#41
  def fetcher; end
  ...
  # source://sidekiq//lib/sidekiq/capsule.rb#96
  def local_redis_pool; end

  # source://sidekiq//lib/sidekiq/capsule.rb#128
  def logger; end

  # source://sidekiq//lib/sidekiq/capsule.rb#124
  def lookup(name); end
  ...
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#27
  def mode; end

  # Returns the value of attribute name.
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#24
  def name; end

  # Returns the value of attribute queues.
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#25
  def queues; end
  ...
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#57
  def queues=(val); end

  # @raise [ArgumentError]
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#102
  def redis; end

  # source://sidekiq//lib/sidekiq/capsule.rb#92
  def redis_pool; end

  # @yield [@server_chain]
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#86
  def server_middleware; end

  # source://sidekiq//lib/sidekiq/capsule.rb#49
  def stop; end

  # Returns the value of attribute weights.
  #
  # source://sidekiq//lib/sidekiq/capsule.rb#28
  def weights; end
end
...
class Sidekiq::JobRecord
  ...
  #
  # source://activejob-uniqueness/0.3.2/lib/active_job/uniqueness/sidekiq_patch.rb#50
  def delete; end
...
class Sidekiq::JobSet < ::Sidekiq::SortedSet
  ...
  # @api private
  #
  # source://activejob-uniqueness/0.3.2/lib/active_job/uniqueness/sidekiq_patch.rb#69
...
class Sidekiq::Queue
  ...
  # @return [Boolean] true
  #
  # source://activejob-uniqueness/0.3.2/lib/active_job/uniqueness/sidekiq_patch.rb#57
  def clear; end
...
class Sidekiq::SortedEntry < ::Sidekiq::JobRecord
  ...
  #
  # source://activejob-uniqueness/0.3.2/lib/active_job/uniqueness/sidekiq_patch.rb#26
  def delete; end
  ...
  # source://activejob-uniqueness/0.3.2/lib/active_job/uniqueness/sidekiq_patch.rb#33
  def remove_job; end
end
