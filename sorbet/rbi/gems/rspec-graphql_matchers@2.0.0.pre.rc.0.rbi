...
class RSpec::GraphqlMatchers::BeOfType < ::RSpec::GraphqlMatchers::BaseMatcher
  ...
  # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/be_of_type.rb#25
  def description; end
  ...
  # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/be_of_type.rb#31
...
class RSpec::GraphqlMatchers::HaveAField < ::RSpec::GraphqlMatchers::BaseMatcher
  ...
  # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/have_a_field.rb#111
  def results; end
end
...
module RSpec::GraphqlMatchers::TypesHelper
  # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#20
  def types; end

  class << self
    def BigInt(*args, **_arg1, &block); end
    def Boolean(*args, **_arg1, &block); end
    def Float(*args, **_arg1, &block); end
    def ID(*args, **_arg1, &block); end
    def ISO8601Date(*args, **_arg1, &block); end
    def ISO8601DateTime(*args, **_arg1, &block); end
    def ISO8601Duration(*args, **_arg1, &block); end
    def Int(*args, **_arg1, &block); end
    def JSON(*args, **_arg1, &block); end
    def Relay(*args, **_arg1, &block); end
    def String(*args, **_arg1, &block); end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_BigInt; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_Boolean; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_Float; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_ID; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_ISO8601Date; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_ISO8601DateTime; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_ISO8601Duration; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_Int; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_JSON; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_Relay; end

    # source://rspec-graphql_matchers//lib/rspec/graphql_matchers/types_helper.rb#14
    def _deprecated_String; end
  end
end
