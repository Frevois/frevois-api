...
# source://roda//lib/roda/plugins/public.rb#48
...
#
# source://roda//lib/roda/plugins/render.rb#224
module Roda::RodaPlugins::Render
  class << self
    # Setup default rendering options.  See Render for details.
    #
    # source://roda//lib/roda/plugins/render.rb#245
    def configure(app, opts = T.unsafe(nil)); end

    # :nocov:
    #
    # source://roda//lib/roda/plugins/render.rb#233
    def tilt_template_compiled_method(template, locals_keys, scope_class); end
  end
end

# source://roda//lib/roda/plugins/render.rb#230
Roda::RodaPlugins::Render::COMPILED_METHOD_SUPPORT = T.let(T.unsafe(nil), TrueClass)

# source://roda//lib/roda/plugins/render.rb#439
module Roda::RodaPlugins::Render::ClassMethods
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#443
  def freeze; end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#471
  def inherited(subclass); end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#464
  def inline_template_block(content); end

  # Return the render options for this class.
  #
  # source://roda//lib/roda/plugins/render.rb#482
  def render_opts; end
...
module Roda::RodaPlugins::Render::InstanceMethods
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#531
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#567
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#594
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#635
  ...
  # to get the template.
  #
  # source://roda//lib/roda/plugins/render.rb#676
  ...
  # used, return nil.
  #
  # source://roda//lib/roda/plugins/render.rb#818
  def view_layout_opts(opts); end
end

# source://roda//lib/roda/plugins/render.rb#229
...
class Roda::RodaPlugins::Render::TemplateMtimeWrapper
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#390
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#373
  def if_modified; end
  ...
  # return the maximum.
  #
  # source://roda//lib/roda/plugins/render.rb#363
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#409
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#416
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#434
