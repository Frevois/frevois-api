...
class Karafka::BaseConsumer
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#34
  def initialize; end

  # @return [Karafka::Connection::Client] kafka connection client
  #
  # source://karafka//lib/karafka/base_consumer.rb#27
  def client; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#23
  def id; end

  # @return [Karafka::Routing::Topic] topic to which a given consumer is subscribed
  #
  # source://karafka//lib/karafka/base_consumer.rb#25
  def messages; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#70
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#59
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#160
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#174
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#195
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#145
  def on_eofed; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#167
  def on_idle; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#42
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def seek_offset(*args, **_arg1, &block); end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#393
  def attempt; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#268
  def eofed; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#302
  def pause(offset, timeout = T.unsafe(nil), manual_pause = T.unsafe(nil)); end

  # Resumes processing of the current topic partition
  #
  # source://karafka//lib/karafka/base_consumer.rb#326
  def resume; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/base_consumer.rb#399
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#387
  def retrying?; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#375
  def revoked?; end
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#346
  ...
  #
  # source://karafka//lib/karafka/base_consumer.rb#262
  def wrap(_action); end
end
...
class Karafka::Connection::Client
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#721
  def kafka; end
  ...
  #
  # source://karafka//lib/karafka/connection/client.rb#741
  def unsubscribe?; end
end
...
class Karafka::Connection::RebalanceManager
  ...
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#37
  def initialize(subscription_group_id, buffer); end
  ...
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#67
  def active?; end

  # Returns the value of attribute assigned_partitions.
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#30
  def assigned_partitions; end

  # @return [Boolean] indicates a state change in the partitions assignment
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#59
  def changed?; end
  ...
  # changed
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#52
  def clear; end
  ...
  # @private
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#75
  ...
  # @private
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#88
  ...
  #
  # source://karafka//lib/karafka/connection/rebalance_manager.rb#105
...
class Karafka::Instrumentation::AssignmentsTracker
  ...
  #
  # source://karafka//lib/karafka/instrumentation/assignments_tracker.rb#47
  def clear; end
  ...
  # @param event [Karafka::Core::Monitoring::Event]
  #
  # source://karafka//lib/karafka/instrumentation/assignments_tracker.rb#56
  ...
  # @param event [Karafka::Core::Monitoring::Event]
  #
  # source://karafka//lib/karafka/instrumentation/assignments_tracker.rb#87
  def on_rebalance_partitions_assigned(event); end
  ...
  # @param event [Karafka::Core::Monitoring::Event]
  #
  # source://karafka//lib/karafka/instrumentation/assignments_tracker.rb#69
  def on_rebalance_partitions_revoked(event); end
...
class Karafka::Instrumentation::LoggerListener
  ...
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#382
  def debug(*args); end
  ...
  #
  # source://karafka//lib/karafka/instrumentation/logger_listener.rb#390
  def log_polling?; end
end
...
class Karafka::Instrumentation::Notifications < ::Karafka::Core::Monitoring::Notifications
  ...
  #
  # source://karafka//lib/karafka/instrumentation/notifications.rb#115
  def initialize; end
end
...
class Karafka::Processing::Executor
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#98
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#127
  def before_schedule_revoked; end

  # Runs code needed before shutdown job is scheduled
  #
  # source://karafka//lib/karafka/processing/executor.rb#148
  def before_schedule_shutdown; end

  # Runs consumer data processing against given batch and handles failures and errors.
  #
  # source://karafka//lib/karafka/processing/executor.rb#92
  def consume; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#122
  def eofed; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#110
  def idle; end
  ...
  #   consumer instance.
  #
  # source://karafka//lib/karafka/processing/executor.rb#143
  def revoked; end
  ...
  #   work is done.
  #
  # source://karafka//lib/karafka/processing/executor.rb#157
  def shutdown; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#87
  def wrap(action, &block); end

  private

  # @return [Object] cached consumer instance
  #
  # source://karafka//lib/karafka/processing/executor.rb#166
  def consumer; end
  ...
  #
  # source://karafka//lib/karafka/processing/executor.rb#207
...
class Karafka::Processing::Jobs::Base
  ...
  # @return [Base] a new instance of Base
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#24
  def initialize; end

  # When redefined can run any code that should run after executing the proper code
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#54
  def after_call; end

  # When redefined can run any code that should run before executing the proper code
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#46
  def before_call; end
  ...
  # @raise [NotImplementedError]
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#49
  def call; end
  ...
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#79
  def finish!; end

  # @return [Boolean] was this job finished.
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#70
  def finished?; end
  ...
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#65
  ...
  #
  # source://karafka//lib/karafka/processing/jobs/base.rb#35
  def wrap(&block); end

  class << self
    # @return [Symbol] Job matching appropriate action
    #
    # source://karafka//lib/karafka/processing/jobs/base.rb#20
    def action; end
...
class Karafka::Processing::Jobs::Consume < ::Karafka::Processing::Jobs::Base
  ...
  # @return [Consume]
  #
  # source://karafka//lib/karafka/processing/jobs/consume.rb#18
  def initialize(executor, messages); end

  # Runs any error handling and other post-consumption stuff on the executor
  #
  # source://karafka//lib/karafka/processing/jobs/consume.rb#41
  def after_call; end

  # Runs the before consumption preparations on the executor
  #
  # source://karafka//lib/karafka/processing/jobs/consume.rb#31
  def before_call; end

  # Runs all the preparation code on the executor that needs to happen before the job is
  # scheduled.
  #
  # source://karafka//lib/karafka/processing/jobs/consume.rb#26
  def before_schedule; end

  # Runs the given executor
  #
  # source://karafka//lib/karafka/processing/jobs/consume.rb#36
  def call; end
...
class Karafka::Processing::Jobs::Eofed < ::Karafka::Processing::Jobs::Base
  ...
  # @return [Eofed]
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#12
  def initialize(executor); end

  # Runs code prior to scheduling this eofed job
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#18
  def before_schedule; end

  # Runs the eofed job via an executor.
  #
  # source://karafka//lib/karafka/processing/jobs/eofed.rb#23
  def call; end
end
...
class Karafka::Processing::Jobs::Idle < ::Karafka::Processing::Jobs::Base
  ...
  # @return [Shutdown]
  #
  # source://karafka//lib/karafka/processing/jobs/idle.rb#14
  def initialize(executor); end

  # Runs code prior to scheduling this idle job
  #
  # source://karafka//lib/karafka/processing/jobs/idle.rb#20
  def before_schedule; end

  # Run the idle work via the executor
  #
  # source://karafka//lib/karafka/processing/jobs/idle.rb#25
  def call; end
end
...
class Karafka::Processing::Jobs::Revoked < ::Karafka::Processing::Jobs::Base
  ...
  # @return [Revoked]
  #
  # source://karafka//lib/karafka/processing/jobs/revoked.rb#12
  def initialize(executor); end

  # Runs code prior to scheduling this revoked job
  #
  # source://karafka//lib/karafka/processing/jobs/revoked.rb#18
  def before_schedule; end

  # Runs the revoking job via an executor.
  #
  # source://karafka//lib/karafka/processing/jobs/revoked.rb#23
  def call; end
end
...
class Karafka::Processing::Jobs::Shutdown < ::Karafka::Processing::Jobs::Base
  ...
  # @return [Shutdown]
  #
  # source://karafka//lib/karafka/processing/jobs/shutdown.rb#13
  def initialize(executor); end

  # Runs code prior to scheduling this shutdown job
  #
  # source://karafka//lib/karafka/processing/jobs/shutdown.rb#19
  def before_schedule; end

  # Runs the shutdown job via an executor.
  #
  # source://karafka//lib/karafka/processing/jobs/shutdown.rb#24
  def call; end
end
...
module Karafka::Processing::Strategies::Default
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#151
  def handle_after_consume; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#130
  def handle_consume; end

  # Runs the consumer `#eofed` method with reporting
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#177
  def handle_eofed; end

  # Code that should run on idle runs without messages available
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#170
  def handle_idle; end
  ...
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#189
  def handle_revoked; end

  # Runs the shutdown code
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#203
  def handle_shutdown; end
  ...
  # @param block [Proc]
  #
  # source://karafka//lib/karafka/processing/strategies/default.rb#122
  def handle_wrap(action, &block); end
...
class Karafka::Processing::Worker
  ...
  # @return [Worker]
  #
  # source://karafka//lib/karafka/processing/worker.rb#31
  def initialize(jobs_queue); end
  ...
  #
  # source://karafka//lib/karafka/processing/worker.rb#41
  def call; end
  ...
  #
  # source://karafka//lib/karafka/processing/worker.rb#51
  def process; end
end
...
class Karafka::Routing::Builder < ::Array
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#87
  def active; end

  # Clears the builder and the draws memory
  #
  # source://karafka//lib/karafka/routing/builder.rb#92
  def clear; end
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#102
  ...
  # @param block [Proc] block we will evaluate within the builder context
  #
  # source://karafka//lib/karafka/routing/builder.rb#76
  def redraw(&block); end
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#119
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#136
  ...
  #
  # source://karafka//lib/karafka/routing/builder.rb#156
