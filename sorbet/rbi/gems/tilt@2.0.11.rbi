...
# source://tilt//lib/tilt/coffee.rb#52
class Tilt::CoffeeScriptLiterateTemplate < ::Tilt::CoffeeScriptTemplate
  class << self
    # @return [Boolean]
    #
    # source://tilt//lib/tilt/coffee.rb#53
    def literate?; end
  end
end
...
#
# source://tilt//lib/tilt/coffee.rb#9
class Tilt::CoffeeScriptTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/coffee.rb#47
  def allows_script?; end

  # source://tilt//lib/tilt/coffee.rb#43
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/coffee.rb#36
  def prepare; end

  class << self
    # source://tilt//lib/tilt/coffee.rb#14
    def default_bare; end

    # source://tilt//lib/tilt/coffee.rb#18
    def default_bare=(value); end

    # DEPRECATED
    #
    # source://tilt//lib/tilt/coffee.rb#23
    def default_no_wrap; end

    # DEPRECATED
    #
    # source://tilt//lib/tilt/coffee.rb#28
    def default_no_wrap=(value); end

    # @return [Boolean]
    #
    # source://tilt//lib/tilt/coffee.rb#32
    def literate?; end
  end
end
