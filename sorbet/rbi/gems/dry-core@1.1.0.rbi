...
module Dry
  class << self
    ...
    # source://dry-types/1.8.1/lib/dry/types.rb#253
...
module Dry::Types
  ...
  class << self
    # source://dry-types/1.8.1/lib/dry/types/constraints.rb#13
    def Rule(options); end

    # source://dry-types/1.8.1/lib/dry/types.rb#115
    def [](name); end

    # source://dry-types/1.8.1/lib/dry/types.rb#163
    def const_missing(const); end

    # source://dry-types/1.8.1/lib/dry/types.rb#82
    def container; end

    # source://dry-types/1.8.1/lib/dry/types.rb#197
    def define_builder(method, &block); end

    # source://dry-types/1.8.1/lib/dry/types.rb#149
    def identifier(klass); end

    # source://dry-types/1.8.1/lib/dry/types.rb#73
    def included(*_arg0); end

    # source://dry-types/1.8.1/lib/dry/types.rb#33
    def loader; end

    # source://dry-core//lib/dry/core/deprecations.rb#202
    def module(*args, &block); end

    # source://dry-types/1.8.1/lib/dry/types.rb#104
    def register(name, type = T.unsafe(nil), &block); end

    # source://dry-types/1.8.1/lib/dry/types.rb#91
    def registered?(class_or_identifier); end

    # source://dry-types/1.8.1/lib/dry/types/constraints.rb#26
    def rule_compiler; end

    # source://dry-types/1.8.1/lib/dry/types.rb#158
    def type_map; end
  end
end

class Dry::Types::Compiler
  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#11
  def initialize(registry); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#15
  def call(ast); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#114
  def compile_fn(fn); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#9
  def registry; end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#17
  def visit(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#110
  def visit_any(meta); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#59
  def visit_array(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#22
  def visit_constrained(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#28
  def visit_constructor(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#100
  def visit_enum(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#65
  def visit_hash(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#80
  def visit_json_array(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#75
  def visit_json_hash(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#95
  def visit_key(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#34
  def visit_lax(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#105
  def visit_map(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#39
  def visit_nominal(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#90
  def visit_params_array(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#85
  def visit_params_hash(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#50
  def visit_rule(node); end

  # source://dry-core//lib/dry/core/deprecations.rb#168
  def visit_safe(*args, &block); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#70
  def visit_schema(node); end

  # source://dry-types/1.8.1/lib/dry/types/compiler.rb#54
...
module Dry::Types::Type
  # source://dry-types/1.8.1/lib/dry/types/type.rb#18
  def ===(input = T.unsafe(nil)); end

  # source://dry-types/1.8.1/lib/dry/types/type.rb#43
