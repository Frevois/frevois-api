...
#
# source://waterdrop//lib/waterdrop/errors.rb#75
...
#
# source://waterdrop//lib/waterdrop/errors.rb#45
...
class WaterDrop::Errors::ProduceManyError < ::WaterDrop::Errors::ProduceError
  ...
  #
  # source://waterdrop//lib/waterdrop/errors.rb#66
  def initialize(dispatched, message); end

  # Returns the value of attribute dispatched.
  #
  # source://waterdrop//lib/waterdrop/errors.rb#61
  def dispatched; end
end
...
#
# source://waterdrop//lib/waterdrop/errors.rb#38
class WaterDrop::Errors::ProducerNotTransactionalError < ::WaterDrop::Errors::BaseError; end
...
class WaterDrop::Errors::ProducerTransactionalCloseAttemptError < ::WaterDrop::Errors::BaseError; end
...
#
# source://waterdrop//lib/waterdrop/errors.rb#42
...
#
# source://waterdrop//lib/waterdrop/errors.rb#49
...
#
# source://waterdrop//lib/waterdrop/errors.rb#35
...
class WaterDrop::Producer
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#166
  def idempotent?; end
  ...
  #   retrieved.
  #
  # source://waterdrop//lib/waterdrop/producer.rb#129
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#138
  def purge; end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#157
  ...
  #   a default one.
  #
  # source://waterdrop//lib/waterdrop/producer.rb#301
  ...
  # @raise [Errors::ProducerNotConfiguredError]
  #
  # source://waterdrop//lib/waterdrop/producer.rb#266
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#309
  def produce(message); end
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#282
  ...
  #
  # source://waterdrop//lib/waterdrop/producer.rb#291
...
module WaterDrop::Producer::Transactions
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#149
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#137
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#201
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#277
  ...
  #
  # source://waterdrop//lib/waterdrop/producer/transactions.rb#220
