...
class ActiveRecord::MigrationContext
  include ::StrongMigrations::MigrationContext
end
...
module StrongMigrations::Checks
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#432
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#330
  def check_remove_index(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#347
  def check_rename_column; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#351
  def check_rename_table; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#355
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#457
  def migration_suffix; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#461
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#369
  def postgresql?; end
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#385
...
module StrongMigrations::SafeMethods
  ...
  #
  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#112
  def disable_transaction; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#119
  ...
  def safe_change_column_null(add_args, validate_args, change_args, remove_args, default, constraints); end
