...
module Roda::RodaPlugins::Base::RequestMethods
  ...
  #
  # source://roda//lib/roda/request.rb#493
  ...
  #
  # source://roda//lib/roda/request.rb#451
  ...
  #
  # source://roda//lib/roda/request.rb#458
  ...
  #
  # source://roda//lib/roda/request.rb#510
  ...
  #
  # source://roda//lib/roda/request.rb#516
  ...
  # returned otherwise.
  #
  # source://roda//lib/roda/request.rb#534
  ...
  #
  # source://roda//lib/roda/request.rb#549
  ...
  # @return [Boolean]
  #
  # source://roda//lib/roda/request.rb#592
  def empty_path?; end
  ...
  # @raise [RodaError]
  #
  # source://roda//lib/roda/request.rb#660
  ...
  # @raise [RodaError]
  #
  # source://roda//lib/roda/request.rb#665
...
#
# source://roda//lib/roda/plugins/class_matchers.rb#72
module Roda::RodaPlugins::ClassMatchers
  class << self
    # source://roda//lib/roda/plugins/class_matchers.rb#77
    def configure(app); end

    # source://roda//lib/roda/plugins/class_matchers.rb#73
    def load_dependencies(app); end
  end
end

# source://roda//lib/roda/plugins/class_matchers.rb#84
module Roda::RodaPlugins::ClassMatchers::ClassMethods
  ...
  # the match block.
  #
  # source://roda//lib/roda/plugins/class_matchers.rb#95
  def class_matcher(klass, matcher, &block); end

  # Freeze the class_matchers hash when freezing the app.
  #
  # source://roda//lib/roda/plugins/class_matchers.rb#106
  def freeze; end
end

# source://roda//lib/roda/plugins/class_matchers.rb#112
module Roda::RodaPlugins::ClassMatchers::RequestMethods
  ...
  #
  # source://roda//lib/roda/plugins/class_matchers.rb#116
  def _consume_segment(convert_meth); end
end
...
# mode is enabled.
#
# source://roda//lib/roda/plugins/content_security_policy.rb#113
module Roda::RodaPlugins::ContentSecurityPolicy
  class << self
    ...
    # @yield [policy]
    #
    # source://roda//lib/roda/plugins/content_security_policy.rb#277
    def configure(app); end
  end
end
...
module Roda::RodaPlugins::ContentSecurityPolicy::InstanceMethods
  ...
  # @yield [policy]
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#291
  def content_security_policy; end
end

# Represents a content security policy.
#
# source://roda//lib/roda/plugins/content_security_policy.rb#115
class Roda::RodaPlugins::ContentSecurityPolicy::Policy
  # @return [Policy] a new instance of Policy
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#188
  def initialize; end

  # source://roda//lib/roda/plugins/content_security_policy.rb#152
  ...
  # source://roda//lib/roda/plugins/content_security_policy.rb#141
  def base_uri(*args); end

  # source://roda//lib/roda/plugins/content_security_policy.rb#172
  def block_all_mixed_content(arg = T.unsafe(nil)); end

  # source://roda//lib/roda/plugins/content_security_policy.rb#183
  ...
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#193
  def clear; end
  ...
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#198
  def freeze; end

  # source://roda//lib/roda/plugins/content_security_policy.rb#162
  ...
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#205
  def header_key; end

  # The header value to use.
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#210
  ...
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#226
  ...
  # @return [Boolean]
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#231
  def report_only?; end
  ...
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#237
  ...
  #          surrounds them with '
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#249
  def append_formatted_value(s, v); end

  # Make object copy use copy of settings, and remove cached header value.
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#268
  def initialize_copy(_); end
end

# source://roda//lib/roda/plugins/content_security_policy.rb#298
module Roda::RodaPlugins::ContentSecurityPolicy::ResponseMethods
  # Unset any content security policy when reinitializing
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#300
  def initialize; end

  # The current content security policy to be used for this response.
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#306
  def content_security_policy; end

  # Do not set a content security policy header for this response.
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#311
  def skip_content_security_policy!; end

  private

  # Set the appropriate content security policy header.
  #
  # source://roda//lib/roda/plugins/content_security_policy.rb#318
  def set_default_headers; end
end
...
# values are ignored.
#
# source://roda//lib/roda/plugins/custom_block_results.rb#41
module Roda::RodaPlugins::CustomBlockResults
  class << self
    # source://roda//lib/roda/plugins/custom_block_results.rb#42
    def configure(app); end
  end
end
...
module Roda::RodaPlugins::CustomBlockResults::ClassMethods
  ...
  #
  # source://roda//lib/roda/plugins/custom_block_results.rb#48
  def freeze; end

  # Specify a block that will be called when an instance of klass
  # is returned as a block result.  The block defines a method.
  #
  # source://roda//lib/roda/plugins/custom_block_results.rb#55
  def handle_block_result(klass, &block); end
end

# source://roda//lib/roda/plugins/custom_block_results.rb#60
module Roda::RodaPlugins::CustomBlockResults::RequestMethods
  ...
  #
  # source://roda//lib/roda/plugins/custom_block_results.rb#65
  def unsupported_block_result(result); end
end
...
module Roda::RodaPlugins::NotFound
  class << self
    ...
    def load_dependencies(app, &_); end
  end
end
...
module Roda::RodaPlugins::Public
  class << self
    ...
    #
    # source://roda//lib/roda/plugins/public.rb#71
    def configure(app, opts = T.unsafe(nil)); end
  end
end

# source://roda//lib/roda/plugins/public.rb#47
Roda::RodaPlugins::Public::ENCODING_EXTENSIONS = T.let(T.unsafe(nil), Hash)

# source://roda//lib/roda/plugins/public.rb#46
Roda::RodaPlugins::Public::ENCODING_MAP = T.let(T.unsafe(nil), Hash)

# source://roda//lib/roda/plugins/public.rb#51
Roda::RodaPlugins::Public::MATCH_METHOD = T.let(T.unsafe(nil), Symbol)

# :nocov:
#
# source://roda//lib/roda/plugins/public.rb#50
...
# source://roda//lib/roda/plugins/public.rb#92
module Roda::RodaPlugins::Public::RequestMethods
  ...
  #
  # source://roda//lib/roda/plugins/public.rb#94
  def public; end
  ...
  #
  # source://roda//lib/roda/plugins/public.rb#148
  def public_serve_compressed(server, path, suffix, encoding); end

  # source://roda//lib/roda/plugins/public.rb#122
...
#
# source://roda//lib/roda/plugins/render.rb#278
module Roda::RodaPlugins::Render
  class << self
    # Setup default rendering options.  See Render for details.
    #
    # source://roda//lib/roda/plugins/render.rb#312
    def configure(app, opts = T.unsafe(nil)); end

    # :nocov:
    #
    # source://roda//lib/roda/plugins/render.rb#300
    ...
    # @return [Boolean]
    #
    # source://roda//lib/roda/plugins/render.rb#288
    def tilt_template_fixed_locals?(template); end
  end
end

# source://roda//lib/roda/plugins/render.rb#284
Roda::RodaPlugins::Render::COMPILED_METHOD_SUPPORT = T.let(T.unsafe(nil), TrueClass)

# source://roda//lib/roda/plugins/render.rb#520
module Roda::RodaPlugins::Render::ClassMethods
  # Return an Tilt::Template object based on the given opts and template_opts.
  #
  # source://roda//lib/roda/plugins/render.rb#539
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#524
  def freeze; end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#552
  def inherited(subclass); end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#545
  def inline_template_block(content); end

  # Return the render options for this class.
  #
  # source://roda//lib/roda/plugins/render.rb#563
  def render_opts; end
...
# source://roda//lib/roda/plugins/render.rb#285
Roda::RodaPlugins::Render::FIXED_LOCALS_COMPILED_METHOD_SUPPORT = T.let(T.unsafe(nil), TrueClass)

# source://roda//lib/roda/plugins/render.rb#589
module Roda::RodaPlugins::Render::InstanceMethods
  ...
  # splat.
  #
  # source://roda//lib/roda/plugins/render.rb#732
  def _call_optimized_template_method(_arg0, locals, &block); end

  # Render the given template. See Render for details.
  #
  # source://roda//lib/roda/plugins/render.rb#591
  def render(template, opts = T.unsafe(nil), &block); end

  # Return the render options for the instance's class.
  #
  # source://roda//lib/roda/plugins/render.rb#603
  def render_opts; end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#612
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#668
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#675
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#722
  ...
  # to get the template.
  #
  # source://roda//lib/roda/plugins/render.rb#794
  ...
  # used, return nil.
  #
  # source://roda//lib/roda/plugins/render.rb#936
  def view_layout_opts(opts); end
end

# source://roda//lib/roda/plugins/render.rb#283
...
#
# source://roda//lib/roda/plugins/render.rb#402
class Roda::RodaPlugins::Render::TemplateMtimeWrapper
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#462
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#479
  def define_compiled_method_cache_value(roda_class, method_name, locals_keys = T.unsafe(nil)); end

  # Whether the underlying template uses fixed locals.
  #
  # @return [Boolean]
  #
  # source://roda//lib/roda/plugins/render.rb#456
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#440
  def if_modified; end
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#490
  ...
  #
  # source://roda//lib/roda/plugins/render.rb#515
...
# source://roda//lib/roda/plugins/_symbol_class_matchers.rb#6
module Roda::RodaPlugins::SymbolClassMatchers_; end

# source://roda//lib/roda/plugins/_symbol_class_matchers.rb#7
module Roda::RodaPlugins::SymbolClassMatchers_::ClassMethods
  ...
  #
  # source://roda//lib/roda/plugins/_symbol_class_matchers.rb#78
  def _merge_matcher_blocks(type, obj, block, matcher_meth); end

  # Backend of symbol_matcher and class_matcher.
  #
  # source://roda//lib/roda/plugins/_symbol_class_matchers.rb#11
  def _symbol_class_matcher(expected_class, obj, matcher, block, &request_class_block); end
end
