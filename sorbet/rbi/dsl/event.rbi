...
class Event
  ...
  module GeneratedAttributeMethods
    ...
    def precise_total_amount_cents; end

    sig { params(value: T.nilable(::BigDecimal)).returns(T.nilable(::BigDecimal)) }
    def precise_total_amount_cents=(value); end

    sig { returns(T::Boolean) }
    def precise_total_amount_cents?; end

    sig { returns(T.nilable(::BigDecimal)) }
    def precise_total_amount_cents_before_last_save; end

    sig { returns(T.untyped) }
    def precise_total_amount_cents_before_type_cast; end

    sig { returns(T::Boolean) }
    def precise_total_amount_cents_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::BigDecimal), T.nilable(::BigDecimal)])) }
    def precise_total_amount_cents_change; end

    sig { returns(T.nilable([T.nilable(::BigDecimal), T.nilable(::BigDecimal)])) }
    def precise_total_amount_cents_change_to_be_saved; end

    sig { params(from: T.nilable(::BigDecimal), to: T.nilable(::BigDecimal)).returns(T::Boolean) }
    def precise_total_amount_cents_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::BigDecimal)) }
    def precise_total_amount_cents_in_database; end

    sig { returns(T.nilable([T.nilable(::BigDecimal), T.nilable(::BigDecimal)])) }
    def precise_total_amount_cents_previous_change; end

    sig { params(from: T.nilable(::BigDecimal), to: T.nilable(::BigDecimal)).returns(T::Boolean) }
    def precise_total_amount_cents_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::BigDecimal)) }
    def precise_total_amount_cents_previously_was; end

    sig { returns(T.nilable(::BigDecimal)) }
    def precise_total_amount_cents_was; end

    sig { void }
    def precise_total_amount_cents_will_change!; end
    ...
    sig { void }
    def restore_precise_total_amount_cents!; end
    ...
    sig { returns(T.nilable([T.nilable(::BigDecimal), T.nilable(::BigDecimal)])) }
    def saved_change_to_precise_total_amount_cents; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_precise_total_amount_cents?; end
