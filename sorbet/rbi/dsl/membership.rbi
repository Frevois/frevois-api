...
class Membership
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Membership]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Membership` class because it declared `has_many :data_exports`.
    ...
    # This method is created by ActiveRecord on the `Membership` class because it declared `has_many :versions`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
