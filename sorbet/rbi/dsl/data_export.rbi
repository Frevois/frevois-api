...
class DataExport
  ...
  module GeneratedAssociationMethods
    ...
    def data_export_part_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def data_export_part_ids=(ids); end

    # This method is created by ActiveRecord on the `DataExport` class because it declared `has_many :data_export_parts`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::DataExportPart::PrivateCollectionProxy) }
    def data_export_parts; end

    sig { params(value: T::Enumerable[::DataExportPart]).void }
    def data_export_parts=(value); end
    ...
    sig { returns(T::Boolean) }
    def membership_previously_changed?; end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.untyped) }
    def resource_query; end

    sig { params(value: T.untyped).returns(T.untyped) }
    def resource_query=(value); end

    sig { returns(T::Boolean) }
    def resource_query?; end

    sig { returns(T.untyped) }
    def resource_query_before_last_save; end

    sig { returns(T.untyped) }
    def resource_query_before_type_cast; end

    sig { returns(T::Boolean) }
    def resource_query_came_from_user?; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def resource_query_change; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def resource_query_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def resource_query_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.untyped) }
    def resource_query_in_database; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def resource_query_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def resource_query_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.untyped) }
    def resource_query_previously_was; end

    sig { returns(T.untyped) }
    def resource_query_was; end

    sig { void }
    def resource_query_will_change!; end
    ...
    sig { void }
    def restore_resource_query!; end
    ...
    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def saved_change_to_resource_query; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_resource_query?; end
