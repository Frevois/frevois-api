...
class PaperTrail::Version
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::String)) }
    def lago_version; end

    sig { params(value: T.nilable(::String)).returns(T.nilable(::String)) }
    def lago_version=(value); end

    sig { returns(T::Boolean) }
    def lago_version?; end

    sig { returns(T.nilable(::String)) }
    def lago_version_before_last_save; end

    sig { returns(T.untyped) }
    def lago_version_before_type_cast; end

    sig { returns(T::Boolean) }
    def lago_version_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def lago_version_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def lago_version_change_to_be_saved; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def lago_version_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def lago_version_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def lago_version_previous_change; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def lago_version_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def lago_version_previously_was; end

    sig { returns(T.nilable(::String)) }
    def lago_version_was; end

    sig { void }
    def lago_version_will_change!; end
    ...
    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def saved_change_to_lago_version; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_lago_version?; end
